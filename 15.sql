...
-- Dumpar data för tabell holiday-maker.bookings: ~7 rows (ungefär)
...
INSERT INTO `bookings` (`id`, `room_id`, `user_id`, `price`, `extra_bed`, `whole_pension`, `half_pension`, `all_inclusive`, `number_of_adults`, `number_of_children`, `from_date`, `to_date`, `paid`) VALUES
	(2, 1005, 5, 500, 2, 1, 0, 1, 1, 1, '2021-05-20', '2021-05-24', NULL),
	(3, 1005, 1, 6000, 1, 1, 0, 1, 4, 0, '2021-09-05', '2021-09-09', NULL),
	(48, 1024, 2, 800, 1, 0, 0, 1, 1, 1, '2021-06-04', '2021-06-07', NULL),
	(49, 1017, 2, 800, 1, 0, 0, 1, 1, 1, '2021-06-04', '2021-06-07', NULL),
	(50, 1017, 2, 800, 1, 0, 0, 1, 1, 1, '2021-06-10', '2021-06-16', NULL),
	(53, 1017, 4, 400, 0, 0, 0, 0, 3, 0, '2021-06-10', '2021-06-23', NULL),
	(54, 1017, 4, 700, 1, 0, 0, 1, 1, 0, '2021-06-17', '2021-06-19', NULL),
	(55, 1093, 4, 680, 1, 1, 0, 0, 2, 0, '2021-06-24', '2021-06-25', NULL),
	(56, 1045, 4, 659, 1, 0, 0, 1, 3, 0, '2021-06-17', '2021-06-20', 0),
	(57, 1035, 4, 650, 0, 1, 0, 0, 2, 0, '2021-06-18', '2021-06-19', 0),
	(58, 1029, 4, 849, 0, 1, 0, 0, 2, 0, '2021-06-10', '2021-06-12', 0),
	(59, 1064, 4, 607, 1, 1, 0, 0, 3, 0, '2021-06-17', '2021-06-18', 1),
	(60, 1017, 4, 400, 0, 0, 0, 0, 1, 0, '2021-06-10', '2021-06-11', 0),
	(61, 1017, 4, 400, 0, 0, 0, 0, 2, 0, '2021-06-10', '2021-06-11', 0);
...
-- Dumpar data för tabell holiday-maker.favorites: ~11 rows (ungefär)
