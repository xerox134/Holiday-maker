...
-- Dumpar data för tabell holiday-maker.bookings: ~6 rows (ungefär)
...
INSERT INTO `bookings` (`id`, `room_id`, `user_id`, `price`, `extra_bed`, `whole_pension`, `half_pension`, `all_inclusive`, `number_of_adults`, `number_of_children`, `from_date`, `to_date`) VALUES
	...
	(49, 1017, 2, 800, 1, 0, 0, 1, 1, 1, '2021-06-04', '2021-06-06');
...
-- Dumpar data för tabell holiday-maker.favorites: ~3 rows (ungefär)
...
-- Dumpar data för tabell holiday-maker.reviews: ~4 rows (ungefär)
DELETE FROM `reviews`;
