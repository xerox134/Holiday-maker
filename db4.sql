...
INSERT INTO `hotels` (`id`, `name`, `country`, `city`, `address`, `pool`, `entertainment`, `childrens_club`, `restaurant`, `distance_to_beach`, `distance_to_center`) VALUES
	(1, 'Keeling, Kozey and Terry', 'Norway', 'Mariestad', '4890 Talmadge Park', 1, 0, 0, 1, 9, 43),
	(2, 'Feil, Koss and Schoen', 'Denmark', 'Fredrikshavn', '74 Dunning Drive', 1, 1, 1, 0, 49, 21),
	(3, 'Johnson Inc', 'Finland', 'Helsinki', '7 Dakota Lane', 0, 1, 1, 1, 74, 37),
	(4, 'Stroman Group', 'Sweden', 'Mora', '21862 Swallow Street', 0, 0, 0, 1, 83, 45),
	(5, 'Yost-Hudson', 'Denmark', 'Köpenhamn', '32886 Hayes Terrace', 1, 1, 0, 1, 29, 51),
	(6, 'Klein Group', 'Sweden', 'Norsborg', '7601 Tony Lane', 1, 0, 1, 1, 77, 70),
	(7, 'Koss-Hagenes', 'Finland', 'Nykarleby', '4 Elmside Crossing', 0, 1, 0, 1, 11, 40),
	(8, 'Thompson Group', 'Sweden', 'Leksand', '247 Briar Crest Hill', 0, 0, 1, 0, 29, 48),
	(9, 'Gleason LLC', 'Norway', 'Oslo', '3189 Kinsman Circle', 0, 1, 0, 1, 64, 66),
	(10, 'Stark Group', 'Denmark', 'Helsingor', '537 Lakeland Circle', 1, 1, 0, 0, 50, 26),
	(11, 'Rippin LLC', 'Finland', 'Tammela', '901 Mayer Trail', 0, 0, 0, 1, 27, 8),
	(12, 'Oberbrunner, Gleason and McClure', 'Sweden', 'Härnösand', '637 Crest Line Hill', 0, 0, 0, 0, 32, 8),
	(13, 'Schaefer Inc', 'Finland', 'Porvoo', '15 Reindahl Lane', 1, 1, 0, 1, 14, 89),
	(14, 'Carroll-Sawayn', 'Finland', 'Helsinki', '22784 Eliot Center', 0, 1, 1, 1, 85, 39),
	(15, 'Klein-Hand', 'Norway', 'Kristiansand S', '5630 Schlimgen Road', 0, 0, 0, 0, 95, 33);
